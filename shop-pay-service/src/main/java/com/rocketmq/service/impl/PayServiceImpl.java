...
import com.rocketmq.mapper.TradeMqProducerTempMapper;
import com.rocketmq.mapper.TradePayMapper;
...
public class PayServiceImpl implements IPayService{
    ...
    public Result createPayment(TradePay tradePay) {
        ...
        long r = tradePayMapper.countByExample(example);
        if(r > 0){
                ...
                threadPoolTaskExecutor.submit(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            log.info("消息发送接收 result: " + result.toString());
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
...
//        SendResult sendResult = rocketMQTemplate.getProducer().send(message);
        final String topicTag = topic + ":" + tag;
        SendResult sendResult = this.rocketMQTemplate.syncSend(topicTag, body);
