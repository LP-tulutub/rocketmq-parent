...
import com.rocketmq.api.IUserService;
import com.rocketmq.enums.ShopCode;
import com.rocketmq.exception.CastException;
import com.rocketmq.mapper.TradeUserMapper;
import com.rocketmq.mapper.TradeUserMoneyLogMapper;
...
public class UserServiceImpl implements IUserService{
    ...
    public Result updateMoneyPaid(TradeUserMoneyLog userMoneyLog) {
        ...
        if(userMoneyLog.getMoneyLogType().intValue()==ShopCode.SHOP_USER_MONEY_REFUND.getCode().intValue()){
            ...
            long r2 = userMoneyLogMapper.countByExample(userMoneyLogExample2);
            if(r2 > 0){
